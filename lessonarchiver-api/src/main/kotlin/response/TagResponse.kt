...
@Serializable
data class TagResponse(val id: String, val name: String, val path: List<TagResponsePathPart>)

@Serializable
data class TagResponsePathPart(val id: String, val name: String)

fun TagDAO.toResponse() = transaction {
